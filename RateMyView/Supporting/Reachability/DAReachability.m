...
static void DAReachabilityCallback(SCNetworkReachabilityRef target, SCNetworkReachabilityFlags flags, void* info)
{
#pragma unused (target)
#if __has_feature(objc_arc)
    DAReachability *reachability = ((__bridge DAReachability*)info);
#else
    DAReachability *reachability = ((DAReachability*)info);
#endif
...
-(BOOL)startNotifier
{
    ...
    self.reachabilitySerialQueue = dispatch_queue_create("com.danielanderton.adhd.reachability", NULL);
    ...
    if (!SCNetworkReachabilitySetCallback(self.reachabilityRef, DAReachabilityCallback, &context))
    {
#ifdef DEBUG
